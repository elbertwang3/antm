...
//
// Tooltips for d3v3.js SVG visualizations
...
d3v3.tip = function() {
  ...
  // Public: Proxy attr calls to the d3v3 tip container.  Sets or gets attribute value.
  //
  ...
  // Public: Proxy style calls to the d3v3 tip container.  Sets or gets a style value.
  //
